...
- **ML**: From recent work at WPP, fully immersed in the ML space, on AWS (Bedrock, Claude), GCP (Gemini) and Azure (ChatGPT) as well as a set of other LLMs (Deepseek R1, Imagen, Bria, Dalle, Veo, Amazon Nova Reel). As I worked on this space I also immersed myself in ML tooling to get a deeper sense of how things are put together ([Pandas](https://pandas.pydata.org/), [Numpy](https://numpy.org/), [Matplotlib](https://matplotlib.org/), [SKLearn](https://scikit-learn.org/), [TensorFlow](https://www.tensorflow.org/), [Hex](https://hex.tech/), [Snowflake](https://www.snowflake.com/en/uk/) and [Streamlit](https://streamlit.io/)). Started ML-assisted development using Co-Pilot and now using Cursor as well as a bunch of other tools. Explored local inference with [Ollama](https://ollama.com/).
